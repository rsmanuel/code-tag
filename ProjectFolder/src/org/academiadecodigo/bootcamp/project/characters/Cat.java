...
public class Cat extends Characters implements KeyboardHandler {
    private Keyboard keyboard;

    public Cat (Map level) {
        super("./pics/characters/catLeft.png", "./pics/characters/catRight.png", new Picture(500, 500, "./pics/characters/catRight.png"), 10, level);
