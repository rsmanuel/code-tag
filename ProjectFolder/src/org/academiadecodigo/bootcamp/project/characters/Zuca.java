...
public class Zuca extends Characters implements KeyboardHandler {
    private Keyboard keyboard;

    public Zuca(Map level) {
        super("./pics/characters/zucaLeft.png", "./pics/characters/zucaRight.png", new Picture(250, 500, "./pics/characters/zucaRight.png"), 10, level);
