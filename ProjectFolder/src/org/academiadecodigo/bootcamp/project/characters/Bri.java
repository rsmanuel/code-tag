...
public class Bri extends Characters implements KeyboardHandler {
    private Keyboard keyboard;

    public Bri (Map level) {
        super("./pics/characters/briLeft.png", "./pics/characters/briRight.png", new Picture(500, 500, "./pics/characters/briRight.png"), 10, level);
